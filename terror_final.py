...
def create_app_ui():
    ...
    html.H1('Terrorism Analysis with Insights', id='Main_title', style={'color':'white','text-align':'center','background-color':'black'}),
    dcc.Tabs(id="Tabs", value="Map", style={'font-weight': 'bold','font-size': 20}, children=[
        dcc.Tab(label="Map tool", id="Map tool", value="Map", children=[
            ...
            html.H3('Select the Year', id='year_title', style={'color':'black','text-align':'center','background-color':'grey'}),
            dcc.RangeSlider(
                      id='year-slider',
